				...
				<div key="mainRouter">
					...
					<div className="container mainContainer">
						<Switch>
							...
							<Route path="/room/:id"  				render={ (props) => <Room {...props} devices={this.props.devices} rooms={this.props.rooms} inputs={this.props.inputs} deviceCallbacks={this.props.deviceCallbacks} roomCallbacks={this.props.roomCallbacks} /> } />
